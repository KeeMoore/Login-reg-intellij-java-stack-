package com.kmoore.loginreg.controllers;

import com.kmoore.loginreg.models.LoginUser;
import com.kmoore.loginreg.models.User;
import com.kmoore.loginreg.services.UserService;
...
public class MainController {
    ...
    public String register(@Valid @ModelAttribute("user") User user, BindingResult bindingResult, Model model, HttpSession session) {
        ...
        User potentialUser = (User) this.userService.register(user, bindingResult);
